...
using DotnetConf._2022Edition.Core.ProjectAggregate.Events;
using DotnetConf._2022Edition.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace DotnetConf._2022Edition.UnitTests.Core.Handlers;
